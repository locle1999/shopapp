...
const MAGIC_NUMBER = 380;

const ILayoutProps = style => {
  ...
  Object.keys(style).map(k => {
    if (
      ...
      return (newStyle[k] = style[k]);
    }
    return (newStyle[k] = constraintLayout(style[k]));
  });
...
export const createShaddowFromElevation = style => {
  try {
